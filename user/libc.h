...
#define AVAILABLEFORK         100
#define DOWN                  200
#define EAT                   300
#define REQUESTLEFTFORK       400
#define REQUESTRIGHTFORK      500
#define NOTWRITTEN            600
...
#define SYS_CREATEPIPE      ( 0x08 )
#define SYS_READPIPE        ( 0x09 )
#define SYS_WRITEPIPE       ( 0x10 )
...
extern int  createPipe     ( int fileDes[2] );
// read a pipe
extern int  readPipe ( int fd , int erase);
// write a pipe
extern void writePipe( int fd , int data);
// further instructions for reading pipe

int  completeReadPipe  ( int fd );
//further instructions for writing pipe
